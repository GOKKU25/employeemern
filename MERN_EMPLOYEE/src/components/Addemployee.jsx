...
const AddEmployee = () => {
  ...
  const [isEdit, setIsEdit] = useState(false);  // Flag to check if it's an update
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEdit) {
        ...
        // POST request for adding a new employee
    ...
    >
      ...
      >
        ...
        <TextField
          ...
          required
          disabled={isEdit} // Disable this field for editing when updating
        />
